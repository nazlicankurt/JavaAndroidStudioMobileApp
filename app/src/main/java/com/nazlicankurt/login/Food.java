...
public class Food extends AppCompatActivity {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        firebaseFirestore.collection("Posts").add(postData).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                Intent intent = new Intent(Food.this, Bottom.class);
                            ...
                            public void onFailure(@NonNull Exception e) {
                                ...
                                Toast.makeText(Food.this, e.getLocalizedMessage().toString(), Toast.LENGTH_LONG).show();
                            }
                        });
    ...
    public void mapseGit(View view) {
        Intent intent= new Intent(Food.this, MapsActivity.class);
        startActivity(intent);
